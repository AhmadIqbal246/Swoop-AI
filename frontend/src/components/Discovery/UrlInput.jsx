    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <input
          ...
          className="w-full h-14 bg-transparent border-0 outline-none focus:outline-none focus:ring-0 text-slate-800 placeholder:text-slate-300 text-lg font-medium selection:bg-primary/20 appearance-none shadow-none"
        />
        ...
        <button 
          type="submit"
          disabled={isLoading}
          className="flex-shrink-0 w-14 h-14 bg-primary text-white rounded-full font-bold tracking-tight shadow-lg transition-all hover:scale-105 active:scale-95 disabled:opacity-50 flex items-center justify-center p-0 ml-2"
        >
          {isLoading ? (
